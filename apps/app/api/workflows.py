...
# ── Skipped-tests audit (read-only: Jira + Gemini) ────────────────────────────
...
# ── Test case coverage review (Confluence + Gemini) ───────────────────────────
...
async def create_review_test_cases_run(
    ...
    (and, for API test cases, the pasted technical-implementation doc) and asks Gemini
