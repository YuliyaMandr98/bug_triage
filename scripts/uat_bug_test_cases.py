...
cases in Azure DevOps. Prerequisites: JIRA_*, AZURE_DEVOPS_*, GEMINI_* configured in .env.
"""
...
from cli_common import build_azure_client, build_gemini_client, build_jira_client, load_env
