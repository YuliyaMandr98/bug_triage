...
implementation page you paste) from Confluence, and asks Gemini to review the test
...
Prerequisites: CONFLUENCE_*, GEMINI_* configured in .env.
"""
...
from cli_common import build_confluence_client, build_gemini_client, load_env
...
async def main() -> None:
    ...
    for name, client in (("Confluence", confluence_client), ("Gemini", gemini_client)):
